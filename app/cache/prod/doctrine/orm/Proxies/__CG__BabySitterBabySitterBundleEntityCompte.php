 ...
 */
class Compte extends \BabySitter\BabySitterBundle\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BabySitter\\BabySitterBundle\\Entity\\Compte' . "\0" . 'idcompte', '' . "\0" . 'BabySitter\\BabySitterBundle\\Entity\\Compte' . "\0" . 'login', '' . "\0" . 'BabySitter\\BabySitterBundle\\Entity\\Compte' . "\0" . 'passwd', '' . "\0" . 'BabySitter\\BabySitterBundle\\Entity\\Compte' . "\0" . 'etat', '' . "\0" . 'BabySitter\\BabySitterBundle\\Entity\\Compte' . "\0" . 'iduser');
        }
